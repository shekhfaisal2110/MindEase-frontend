...
//         {/* Points Summary Card */}
//         <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-3xl p-6 mb-12 border border-emerald-100">
//           <h3 className="text-xl font-bold text-emerald-800 mb-3 flex items-center gap-2">⭐ How to earn points</h3>
//           <p className="text-emerald-700 mb-4">Every positive action in MindEase earns you points. Here's the breakdown:</p>
//           <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
//             <div className="bg-white rounded-xl p-2 text-center">📄 Page View: +1</div>
//             <div className="bg-white rounded-xl p-2 text-center">⏰ Hourly Emotion: +5</div>
//             <div className="bg-white rounded-xl p-2 text-center">💭 Check‑In: +1</div>
//             <div className="bg-white rounded-xl p-2 text-center">🙏 Gratitude: +2</div>
//             <div className="bg-white rounded-xl p-2 text-center">💬 Affirmation: +1</div>
//             <div className="bg-white rounded-xl p-2 text-center">🧘 Therapy: +1</div>
//             <div className="bg-white rounded-xl p-2 text-center">✉️ Letter: +20</div>
//             <div className="bg-white rounded-xl p-2 text-center">✅ Daily Habit: +3</div>
//             <div className="bg-white rounded-xl p-2 text-center">⚡ React/Response: +5</div>
//             <div className="bg-white rounded-xl p-2 text-center">🎯 Ikigai Item: +10</div>
//             <div className="bg-white rounded-xl p-2 text-center">🧠 CBT Record: +10</div>
//             <div className="bg-white rounded-xl p-2 text-center">💡 Motivation: +5 (if approved)</div>
//             <div className="bg-white rounded-xl p-2 text-center">🃏 Coping Card: +2 (use) / +5 (create)</div>
//             <div className="bg-white rounded-xl p-2 text-center">🌱 Tiny Win: +3</div>
//             <div className="bg-white rounded-xl p-2 text-center">👨‍👩‍👧 Time with Loved Ones: +20</div>
//             <div className="bg-white rounded-xl p-2 text-center">📱 Digital Wellbeing: +5</div>
//             <div className="bg-white rounded-xl p-2 text-center">🌿 Wellbeing Toolkit: +5</div>
//             <div className="bg-white rounded-xl p-2 text-center">🏆 Badges: +20 each</div>
//             <div className="bg-white rounded-xl p-2 text-center">😴 Sleep Log: +2</div>
//           </div>
//         </div>
