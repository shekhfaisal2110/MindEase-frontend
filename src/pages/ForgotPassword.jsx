...
const ForgotPassword = React.memo(() => {
  ...
  }, [userId, otp, newPassword, confirmPassword, navigate]);
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-3xl sm:rounded-[2.5rem] shadow-2xl shadow-indigo-100 p-6 sm:p-10 md:p-12 max-w-md w-full border border-white transition-all">
        ...
        {step === 1 ? (
          ...
          <form onSubmit={handleReset} className="space-y-4">
            ...
            <div className="relative">
              <label htmlFor="confirmPassword" className="text-[10px] font-black uppercase tracking-widest text-slate-400 absolute top-3 left-4">
                Confirm Password
              </label>
              <input
                id="confirmPassword"
