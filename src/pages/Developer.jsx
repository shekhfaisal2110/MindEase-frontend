...
// // Lazy load confetti – reduces initial bundle by ~30KB
...
//           {[...Array(2)].map((_, i) => <div key={i} className="h-10 w-24 bg-slate-200 rounded-full" />)}
//         </div>
//       </div>
//     </div>
//   </div>
...
//   const skills = React.useMemo(() => ['React', 'Node.js', 'ExpressJS', 'MongoDB', 'Tailwind', 'PWA'], []);
...
//                       target="_blank"
//                       rel="noopener noreferrer"
//                       className="flex items-center gap-2 px-4 py-2 bg-slate-50 hover:bg-slate-100 rounded-full transition-all duration-200 group touch-manipulation"
//                       title={link.label}
//                     >
//                       <link.icon className={`w-5 h-5 ${link.color} group-hover:scale-110 transition-transform`} />
//                       <span className="text-sm font-medium text-slate-700 group-hover:text-indigo-600">{link.label}</span>
...
//                 type="submit"
//                 disabled={loading}
//                 className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 rounded-xl transition disabled:opacity-50 text-sm md:text-base active:scale-95 touch-manipulation"
//               >
//                 {loading ? 'Sending...' : 'Send Message'}
//               </button>
//             </form>
...
//               className="w-full flex justify-between items-center text-left font-bold text-slate-800 touch-manipulation"
//             >
//               <span className="text-base md:text-lg flex items-center gap-2">
//                 <span>📬</span> Conversations
//                 <span className="text-xs font-normal text-slate-400 ml-1">({messages.length})</span>
...
//             <button
//               onClick={() => setShowFullscreenPhoto(false)}
//               className="absolute -top-12 right-0 text-white hover:text-gray-300 transition-colors touch-manipulation"
//               aria-label="Close fullscreen photo"
//             >
//               <FaTimes className="w-8 h-8" />
//             </button>
