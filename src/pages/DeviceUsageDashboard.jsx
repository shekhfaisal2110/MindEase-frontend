...
//             className={`px-4 sm:px-6 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all whitespace-nowrap ${activeTab === 'device' ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
//           >
//             📱 Device Time
//           </button>
//           <button
//             onClick={() => setActiveTab('apps')}
//             className={`px-4 sm:px-6 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all whitespace-nowrap ${activeTab === 'apps' ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
//           >
//             📱 App Usage
//           </button>
//           <button
//             onClick={() => setActiveTab('analytics')}
//             className={`px-4 sm:px-6 py-2 rounded-xl text-xs sm:text-sm font-bold transition-all whitespace-nowrap ${activeTab === 'analytics' ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
//           >
//             📊 Analytics
//           </button>
//         </div>
...
// src/pages/DeviceUsageDashboard.jsx
