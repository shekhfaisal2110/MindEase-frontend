...
const Login = () => {
  ...
  // MAIN LOGIN – no blocking extra calls
  const handleSubmit = useCallback(async (e) => {
    ...
    try {
      ...
      // 🔥 Login history is fetched in the background – no blocking
      api.get('/auth/login-history', {
        headers: { Authorization: `Bearer ${accessToken}` }
      }).then((historyRes) => {
        localStorage.setItem('loginHistory', JSON.stringify(historyRes.data));
  ...
  }, [email, password, rememberMe, login, navigate, from]);
